...
const handleClickShowPassword = (e) => setShowPassword((show) => !show);
  ...
  <Box sx = {
        ...
        square sx = {
            { height: 450, width: 600, padding: 2,backgroundColor:'#374151' ,borderRadius:'3vh' }
        }>
...

{
      ...
      <FormControl sx={{ m: 1, width: '80%', border:'2px solid #00ffd0 ',borderRadius:'50px' }}  variant="outlined">
        ...
        !submitted ? <p style={{}} className="message">Password Is Not Valid </p>:null
      ...
      <p style = {
         ...
         <p style = {
            { marginTop: '15px' }
        }><Link  style={{ color:'#00ffd0'}} to="/ForgotPassword" >Forgot Password</Link>
         </p>
      </Box>
        </form>
        </Paper>
